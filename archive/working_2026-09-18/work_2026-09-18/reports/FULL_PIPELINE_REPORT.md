...
**Release:** 2026-09-16
**Generated:** 2026-09-18T00:39:22.316542+00:00
**Overall:** PASS
**Checks:** 43/43 passed
...
| `selected_41stream` | **PASS** | data/production/ssz_p5_SELECTED_41STREAM_V2_2026-09-16.csv | present |
...
| Check | Status | Value | Criterion |
|---|---|---:|---|
| `production_blacklist` | **PASS** | 13 | machine-readable blacklist present |

## codex_handoff

| Check | Status | Value | Criterion |
|---|---|---:|---|
| `self_contained_handoff` | **PASS** | 0 | exit code 0 |
