...
sl=slice(3970,3985); raw=R.iloc[sl].reset_index(drop=True);src=S.iloc[sl].reset_index(drop=True)
...
def vals(d):
 ...
 return out
rows=[]
for q6,s1,a4 in itertools.product([-50,-20,-10,-5,-2,-1,0.1,0.25,0.5,1],[.01,.05,.2,1,5,20,100],[-1000,-500,-200,-100,-50,-20,0,20,50,100,200,500,1000]):
 try:
